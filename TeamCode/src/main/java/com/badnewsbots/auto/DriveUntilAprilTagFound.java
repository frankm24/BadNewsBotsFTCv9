...
public class DriveUntilAprilTagFound implements AutonomousTask {
    ...
    public DriveUntilAprilTagFound(AprilTagProcessor aprilTagProcessor, MecanumDrive drive, int targetTagId, double leftX, double leftY, double rightX, double speedMultiplier) {
