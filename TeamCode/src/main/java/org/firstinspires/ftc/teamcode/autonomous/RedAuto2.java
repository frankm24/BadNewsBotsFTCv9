...
public final class RedAuto2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TeamPropProcessor teamPropProcessor = new TeamPropProcessor(640, 480, TeamPropProcessor.Alliance.RED, TeamPropProcessor.DetectionMode.RIGHT_TWO);
        ...
        setManualExposure(frontVisionPortal, CenterstageCompBot.exposureTimeMs, CenterstageCompBot.gain);
        ...
        switch (location) {
            case RIGHT:
                ...
                taskList.add(new DriveUntilAprilTagFoundTask(aprilTagProcessor, autoDrive, 4, 0, 0, -0.5, 1));
                ...
                taskList.add(new DriveToAprilTagTask(CameraOrientation.FRONT, aprilTagProcessor, teleOpDrive, telemetry, 6, 15.7, 1, 0, 1.5, 0, 0.5));
                taskList.add(new RunCodeBlockTask(() -> {
            ...
            case CENTER:
                ...
                taskList.add(new DriveToAprilTagTask(CameraOrientation.FRONT, aprilTagProcessor, teleOpDrive, telemetry, 5, 15.7, 1, 0, 1.5, 0, 0.5));
                taskList.add(new RunCodeBlockTask(() -> {
                    pud.setGrabbyTargetGrip(PUD.GrabbyGrip.OPEN);
                }));
                taskList.add(new SetMotorPowersFromGamepadVectorTask(autoDrive, 0, 0.4,0, 1));
            ...
            case LEFT:
                ...
                taskList.add(new DriveToAprilTagTask(CameraOrientation.FRONT, aprilTagProcessor, teleOpDrive, telemetry, 4, targetRange, 1, 0, 1.5, 0, 0.5));
                taskList.add(new RunCodeBlockTask(() -> {
                    pud.setGrabbyTargetGrip(PUD.GrabbyGrip.OPEN);
                }));
                taskList.add(new SetMotorPowersFromGamepadVectorTask(autoDrive, 0, 0.4,0, 1));
